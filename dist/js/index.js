...
(function () {
  ...
  /** @type {string} */
  const _focusableElementsString = ['a[href]', 'area[href]', 'input:not([disabled])', 'select:not([disabled])', 'textarea:not([disabled])', 'button:not([disabled])', 'details', 'summary', 'iframe', 'object', 'embed', 'video', '[contenteditable]'].join(',');
...
!function (e) {
  ...
  e.ui = e.ui || {}, e.ui.version = "1.14.1";
  var t,
    i,
    s = 0,
    n = Array.prototype.hasOwnProperty,
    a = Array.prototype.slice;
  t = e.cleanData, e.cleanData = function (i) {
    var s, n, a;
    for (a = 0; null != (n = i[a]); a++) (s = e._data(n, "events")) && s.remove && e(n).triggerHandler("remove");
    t(i);
    ...
    var d = h + "-" + t;
    return s || (s = i, i = e.Widget), Array.isArray(s) && (s = e.extend.apply(null, [{}].concat(s))), e.expr.pseudos[d.toLowerCase()] = function (t) {
      return !!e.data(t, d);
      ...
      _proto: e.extend({}, s),
      _childConstructors: []
    }), (o = new i()).options = e.widget.extend({}, o.options), e.each(s, function (e, t) {
      ...
      r[e] = function () {
        ...
        return function () {
          var e,
            i = this._super,
            a = this._superApply;
          return this._super = s, this._superApply = n, e = t.apply(this, arguments), this._super = i, this._superApply = a, e;
        };
      }();
    ...
    for (var i, s, o = a.call(arguments, 1), r = 0, h = o.length; r < h; r++) for (i in o[r]) s = o[r][i], n.call(o[r], i) && void 0 !== s && (e.isPlainObject(s) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], s) : e.widget.extend({}, s) : t[i] = s);
    return t;
    ...
    e.fn[t] = function (n) {
      ...
      return o ? this.length || "instance" !== n ? this.each(function () {
        var i,
          a = e.data(this, s);
        return "instance" === n ? (h = a, !1) : a ? "function" != typeof a[n] || "_" === n.charAt(0) ? e.error("no such method '" + n + "' for " + t + " widget instance") : (i = a[n].apply(a, r)) !== a && void 0 !== i ? (h = i && i.jquery ? h.pushStack(i.get()) : i, !1) : void 0 : e.error("cannot call methods on " + t + " prior to initialization; attempted to call method '" + n + "'");
      }) : h = void 0 : (r.length && (n = e.widget.extend.apply(null, [n].concat(r))), this.each(function () {
        var t = e.data(this, s);
    ...
    _createWidget: function (t, i) {
      i = e(i || this.defaultElement || this)[0], this.element = e(i), this.uuid = s++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = e(), this.hoverable = e(), this.focusable = e(), this.classesElementLookup = {}, i !== this && (e.data(i, this.widgetFullName, this), this._on(!0, this.element, {
        remove: function (e) {
    ...
    option: function (t, i) {
      ...
      if ("string" == typeof t) {
        if (o = {}, t = (s = t.split(".")).shift(), s.length) {
          for (a = 0, n = o[t] = e.widget.extend({}, this.options[t]); a < s.length - 1; a++) n[s[a]] = n[s[a]] || {}, n = n[s[a]];
    ...
    _classes: function (t) {
      ...
      function n(n, a) {
        var o, r;
        for (r = 0; r < n.length; r++) o = s.classesElementLookup[n[r]] || e(), t.add ? (function () {
          var i = [];
          t.element.each(function (t, n) {
            e.map(s.classesElementLookup, function (e) {
              return e;
            }).some(function (e) {
              return e.is(n);
            }) || i.push(n);
        ...
        }(), o = e(e.uniqueSort(o.get().concat(t.element.get())))) : o = e(o.not(t.element).get()), s.classesElementLookup[n[r]] = o, i.push(n[r]), a && t.classes[n[r]] && i.push(t.classes[n[r]]);
      }
      return (t = e.extend({
    ...
    _trigger: function (t, i, s) {
      ...
      return this.element.trigger(i, s), !("function" == typeof o && !1 === o.apply(this.element[0], [i].concat(s)) || i.isDefaultPrevented());
    }
  }, e.each({
    show: "fadeIn",
    hide: "fadeOut"
    ...
    e.Widget.prototype["_" + t] = function (s, n, a) {
      ...
      "number" == typeof (n = n || {}) ? n = {
        duration: n
      } : !0 === n && (n = {}), o = !e.isEmptyObject(n), n.complete = a, n.delay && s.delay(n.delay), o && e.effects && e.effects.effect[r] ? s[t](n) : r !== t && s[r] ? s[r](n.duration, n.easing, a) : s.queue(function (i) {
    ...
    options: {
      ...
      event: "click",
      header: function (e) {
        return e.find("> li > :first-child").add(e.find("> :not(li)").filter(function (e) {
          return e % 2 == 0;
        }));
      },
      heightStyle: "auto",
    ...
    _setOption: function (e, t) {
      ...
      "event" === e && (this.options.event && this._off(this.headers, this.options.event), this._setupEvents(t)), this._super(e, t), "collapsible" !== e || t || !1 !== this.options.active || this._activate(0), "icons" === e && (this._destroyIcons(), t && this._createIcons());
    },
    _setOptionDisabled: function (e) {
    ...
    _animate: function (e, t, i) {
      ...
      return ("number" == typeof l && (a = l), "string" == typeof l && (n = l), n = n || l.easing || c.easing, a = a || l.duration || c.duration, t.length) ? e.length ? void (s = e.show().outerHeight(), t.animate(this.hideProps, {
        duration: a,
        easing: n,
        step: function (e, t) {
          t.now = Math.round(e);
      ...
      })) : t.animate(this.hideProps, a, n, u) : e.animate(this.showProps, a, n, u);
    },
    _toggleComplete: function (e) {
      var t = e.oldPanel,
        i = t.prev();
      this._removeClass(t, "ui-accordion-content-active"), this._removeClass(i, "ui-accordion-header-active")._addClass(i, "ui-accordion-header-collapsed"), this._trigger("activate", null, e);
    }
  });
});
})();
  ...
  for (let i = 0; i < document.body.children.length; i++) {
    if (elem === burgerMenu.get(0) && document.body.children[i] === $('.header').get(0)) {
      ...
      for (let k = 0; k < $('.header__container').get(0).children.length; k++) {
        if ($('.header__container').get(0).children[k] === $('.header__burger').get(0)) $('.header__container').get(0).children[k].inert = false;else $('.header__container').get(0).children[k].inert = true;
      }
    }
  }
  ;
...
$(document).click(function (e) {
  if ($(e.target).is('.modal-form') || $(e.target).is('.modal-form__wrapper')) {
    hide_modalForm();
  } else if ($(e.target).is('.burger-menu') || $(e.target).is('.burger-menu__link-text') || $(e.target).is('.header__container') || $(e.target).is('body')) {
    hide_burgerMenu();
  }
});
...
buttonPets.click(function (e) {
  ...
  for (let i = stop + 1; i < pets.length; i++) {
    ...
    pic[k].src = `./dist/img/${pets[i].pictureName}80.${pets[i].extention}`;
    pic[k].alt = pets[i].id;
    source[t].srcset = `./dist/img/${pets[i].pictureName}80.avif`;
    source[t + 1].srcset = `./dist/img/${pets[i].pictureName}80.webp`;
    k++;
    t += 2;
  }
