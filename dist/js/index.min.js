...
const modalForm=$(".modal-form"),header__burger=$(".header__burger"),burgerMenu=$(".burger-menu"),headerPhone=$(".header__phone"),burgerMenu__linkTtext=$(".burger-menu__link-text"),burgerMenu__item=$(".burger-menu__item"),burgerBorderOne=$(".header__burger-border:nth-child(1)"),burgerBorderTwo=$(".header__burger-border:nth-child(2)"),burgerBorderThree=$(".header__burger-border:nth-child(3)");let prevActiveElement;function addInnert(e){prevActiveElement=document.activeElement;for(let n=0;n<document.body.children.length;n++)document.body.children[n]!==e&&(document.body.children[n].inert=!0);for(let t=0;t<document.body.children.length;t++)if(e===burgerMenu.get(0)&&document.body.children[t]===$(".header").get(0)){document.body.children[t].inert=!1;for(let o=0;o<$(".header__container").get(0).children.length;o++)$(".header__container").get(0).children[o]===$(".header__burger").get(0)?$(".header__container").get(0).children[o].inert=!1:$(".header__container").get(0).children[o].inert=!0}e.inert=!1,e.closest("[inert]")&&(e.closest("[inert]").inert=!1);for(let d=0;d<window.elemsInert.length;d++)if(e===window.elemsInert[d].elem&&window.elemsInert[d].esc){function r(e){"Escape"==e.key&&window.elemsInert[d].esc(),document.removeEventListener("keydown",r)}document.addEventListener("keydown",r)}}function activationInnert(e){function r(r){if(r){for(let e=0;e<document.body.children.length;e++)document.body.children[e]!==r&&(document.body.children[e].inert=!1);for(let e=0;e<document.body.children.length;e++)if(r===burgerMenu.get(0))for(let e=0;e<$(".header__container").get(0).children.length;e++)$(".header__container").get(0).children[e].inert=!1;r.innert=!0,prevActiveElement.focus()}for(let r=0;r<e.length;r++)(window.screen.width<=e[r].breakpoints||!e[r].breakpoints)&&(e[r].elem.inert=!0)}return window.elemsInert=e,r(),r}const removeInnert=activationInnert([{elem:burgerMenu.get(0),esc:hide_burgerMenu},{elem:modalForm.get(0),esc:hide_modalForm}]);function hide_burgerMenu(){burgerBorderOne.css({transform:"rotate(0)"}),burgerBorderTwo.css({transform:"rotate(0)"}),burgerBorderThree.show(),burgerMenu.hide(500),removeInnert(burgerMenu.get(0)),header__burger.toggleClass("header__burger_active")}function show_burgerMenu(){burgerBorderOne.css({transform:"rotate(45deg)","transform-origin":"-2px 11px"}),burgerBorderTwo.css({transform:"rotate(-45deg)","transform-origin":"32px 15px"}),burgerBorderThree.hide(),burgerMenu.show(500),addInnert(burgerMenu.get(0)),header__burger.toggleClass("header__burger_active")}function hide_modalForm(){modalForm.hide(500),removeInnert(modalForm.get(0))}burgerMenu__linkTtext.click((function(){hide_burgerMenu()})),burgerMenu__item.click((function(){hide_burgerMenu()})),$(".paw-button").click((function(){modalForm.show(500),addInnert(modalForm.get(0))})),$(".modal-form__close-btn").click((function(){modalForm.hide(500),removeInnert(modalForm.get(0))})),$(document).click((function(e){console.log($(e.target)),$(e.target).is(".modal-form")||$(e.target).is(".modal-form__wrapper")?hide_modalForm():($(e.target).is(".burger-menu")||$(e.target).is(".burger-menu__link-text")||$(e.target).is(".header__container")||$(e.target).is("body"))&&hide_burgerMenu()})),header__burger.click((function(){header__burger.hasClass("header__burger_active")?hide_burgerMenu():show_burgerMenu()}));
