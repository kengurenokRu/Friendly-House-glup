...
"use strict";var prevActiveElement,modalForm=$(".modal-form"),header__burger=$(".header__burger"),burgerMenu=$(".burger-menu"),headerPhone=$(".header__phone"),burgerMenu__linkTtext=$(".burger-menu__link-text"),burgerMenu__item=$(".burger-menu__item"),burgerBorderOne=$(".header__burger-border:nth-child(1)"),burgerBorderTwo=$(".header__burger-border:nth-child(2)"),burgerBorderThree=$(".header__burger-border:nth-child(3)");function addInnert(e){prevActiveElement=document.activeElement;for(var r=0;r<document.body.children.length;r++)document.body.children[r]!==e&&(document.body.children[r].inert=!0);for(var n=0;n<document.body.children.length;n++)if(e===burgerMenu.get(0)&&document.body.children[n]===$(".header").get(0)){document.body.children[n].inert=!1;for(var t=0;t<$(".header__container").get(0).children.length;t++)$(".header__container").get(0).children[t]===$(".header__burger").get(0)?$(".header__container").get(0).children[t].inert=!1:$(".header__container").get(0).children[t].inert=!0}e.inert=!1,e.closest("[inert]")&&(e.closest("[inert]").inert=!1);for(var o=function(r){if(e===window.elemsInert[r].elem&&window.elemsInert[r].esc){var n=function(e){"Escape"==e.key&&window.elemsInert[r].esc(),document.removeEventListener("keydown",n)};document.addEventListener("keydown",n)}},d=0;d<window.elemsInert.length;d++)o(d)}function activationInnert(e){function r(r){if(r){for(var n=0;n<document.body.children.length;n++)document.body.children[n]!==r&&(document.body.children[n].inert=!1);for(var t=0;t<document.body.children.length;t++)if(r===burgerMenu.get(0))for(var o=0;o<$(".header__container").get(0).children.length;o++)$(".header__container").get(0).children[o].inert=!1;r.innert=!0,prevActiveElement.focus()}for(var d=0;d<e.length;d++)(window.screen.width<=e[d].breakpoints||!e[d].breakpoints)&&(e[d].elem.inert=!0)}return window.elemsInert=e,r(),r}var removeInnert=activationInnert([{elem:burgerMenu.get(0),esc:hide_burgerMenu},{elem:modalForm.get(0),esc:hide_modalForm}]);function hide_burgerMenu(){burgerBorderOne.css({transform:"rotate(0)"}),burgerBorderTwo.css({transform:"rotate(0)"}),burgerBorderThree.show(),burgerMenu.hide(500),removeInnert(burgerMenu.get(0)),header__burger.toggleClass("header__burger_active")}function show_burgerMenu(){burgerBorderOne.css({transform:"rotate(45deg)","transform-origin":"-2px 11px"}),burgerBorderTwo.css({transform:"rotate(-45deg)","transform-origin":"32px 15px"}),burgerBorderThree.hide(),burgerMenu.show(500),addInnert(burgerMenu.get(0)),header__burger.toggleClass("header__burger_active")}function hide_modalForm(){modalForm.hide(500),removeInnert(modalForm.get(0))}burgerMenu__linkTtext.click((function(){hide_burgerMenu()})),burgerMenu__item.click((function(){hide_burgerMenu()})),$(".paw-button").click((function(){modalForm.show(500),addInnert(modalForm.get(0))})),$(".modal-form__close-btn").click((function(){modalForm.hide(500),removeInnert(modalForm.get(0))})),$(document).click((function(e){console.log($(e.target)),$(e.target).is(".modal-form")||$(e.target).is(".modal-form__wrapper")?hide_modalForm():($(e.target).is(".burger-menu")||$(e.target).is(".burger-menu__link-text")||$(e.target).is(".header__container")||$(e.target).is("body"))&&hide_burgerMenu()})),header__burger.click((function(){header__burger.hasClass("header__burger_active")?hide_burgerMenu():show_burgerMenu()}));
//# sourceMappingURL=dist-maps/index.min.js.map
